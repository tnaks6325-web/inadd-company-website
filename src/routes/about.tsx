        ...
        <div class="about-intro-grid">
          ...
          <div class="about-intro-text">
            ...
            <div class="ai-desc-block">
              <p>2019년, 인애드컴퍼니는 브랜드가 '설명'하지 않아도 선택받는 구조를 만드는 일에서 시작했습니다.</p>
              <p>바이럴·인플루언서·유튜브·검색/SEO·리뷰·PPL 등 채널 전반을 아우르되, 핵심은 언제나 메시지의 설득력입니다.</p>
              <p>광고 같은 노출이 아니라 자연스러운 확산으로, 브랜드의 인지도와 신뢰가 오래 남도록 설계합니다.</p>
            </div>
